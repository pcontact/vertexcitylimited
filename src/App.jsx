    ...
    <header className="bg-surface/90 backdrop-blur-md sticky top-0 z-50 border-b border-outline-variant/30 shadow-sm">
      <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
        <a className="inline-flex items-center gap-3 min-w-0" href="#" aria-label="Vertex City Ltd. home">
          <img className="h-12 w-12 object-contain shrink-0" src="/images/logo.png" alt="Vertex City Ltd." />
          <span className="text-xl sm:text-headline-md font-headline-md font-extrabold text-primary whitespace-nowrap">
            Vertex City Ltd.
          </span>
        </a>
...
function Hero() {
  return (
    <RevealSection className="relative min-h-[600px] flex items-center pt-8 overflow-hidden">
      ...
      <div className="relative z-20 w-full px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="max-w-3xl text-on-primary">
          <p className="text-label-sm font-label-sm uppercase tracking-[0.18em] text-secondary-container mb-4">
          ...
          <p className="text-body-lg font-body-lg mb-10 opacity-90 max-w-2xl">
            Helping you invest in prime land and property with confidence, flexibility, and expert support.
          </p>
          <div className="flex flex-wrap gap-4">
            <a className="bg-primary text-on-primary px-8 py-4 rounded-lg font-bold flex items-center gap-2 hover:scale-105 transition-all" href="#services">
              Explore Our Services
              <Icon>arrow_forward</Icon>
            </a>
            <a className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-lg font-bold flex items-center gap-2 hover:bg-white/20 transition-all" href="#contact">
              <Icon>call</Icon>
              Speak With an Advisor
            </a>
          </div>
...
function Services() {
  return (
    <RevealSection id="services" className="py-section-padding px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-end mb-10">
        <div>
          <h2 className="text-headline-lg font-headline-lg text-primary">Our Services</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
        {services.map((service) => (
          <article className="bg-surface-container-low p-6 rounded-xl group hover:bg-primary transition-all duration-300" key={service.title}>
            <Icon className="text-primary group-hover:text-on-primary text-4xl mb-4">{service.icon}</Icon>
            <h3 className="text-headline-md font-headline-md text-primary group-hover:text-on-primary mb-3">{service.title}</h3>
...
function InvestmentSolutions() {
  return (
    <RevealSection id="invest" className="bg-surface-container-lowest py-section-padding">
      <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 items-start">
          <div>
            ...
            <h2 className="text-headline-lg font-headline-lg text-primary mb-4">Investment & Property Solutions Built Around Trust</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-gutter">
            {investmentSolutions.map((solution) => (
              <article className="bg-white rounded-2xl p-6 shadow-sm border border-outline-variant/20 hover:shadow-xl transition-all" key={solution.title}>
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-5">
                  <Icon className="text-primary text-3xl">{solution.icon}</Icon>
                </div>
                <h3 className="text-headline-md font-headline-md text-primary mb-3">{solution.title}</h3>
...
function WhyVertexCity() {
  return (
    <RevealSection id="why-us" className="py-section-padding px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-headline-lg font-headline-lg text-primary mb-4">Why Choose Vertex City Ltd.?</h2>
...
function Process() {
  return (
    <RevealSection id="about" className="bg-surface py-section-padding overflow-hidden">
      <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-headline-lg font-headline-lg text-primary mb-4">A Clear Path From Interest to Ownership</h2>
          <p className="text-body-lg font-body-lg text-outline max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter">
          {processSteps.map(([icon, title, description], index) => (
            <article className="bg-white p-8 rounded-2xl shadow-sm border border-outline-variant/20" key={title}>
...
function ContactCta() {
  return (
    <RevealSection id="contact" className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto py-12">
      <div className="relative bg-primary rounded-[40px] overflow-hidden p-8 md:p-20">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-headline-lg-mobile md:text-display-xl font-display-xl text-on-primary mb-6">Ready to Make a Confident Property Decision?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a className="bg-secondary text-on-secondary px-10 py-5 rounded-full font-bold hover:bg-secondary/90 transition-all whitespace-nowrap shadow-xl text-center" href="tel:09044396835">
              Call 09044396835
            </a>
            <a className="bg-white/10 border border-white/20 text-on-primary px-10 py-5 rounded-full font-bold hover:bg-white/20 transition-all whitespace-nowrap text-center" href="#services">
              View Services
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 opacity-70">
            <li className="flex gap-2">
              <Icon className="text-sm">location_on</Icon> Port-Harcourt, Rivers State
            </li>
            <li className="flex gap-2">
              <Icon className="text-sm">call</Icon>
            ...
            <li className="flex gap-2">
              <Icon className="text-sm">mail</Icon>
              <a className="hover:text-on-primary hover:opacity-100 transition-all break-all" href="mailto:info@vertexcitylimited.com">
